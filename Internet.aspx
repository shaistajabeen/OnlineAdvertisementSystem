<%@ Page Title="" Language="C#" MasterPageFile="~/Adsmedium.Master" AutoEventWireup="true" CodeBehind="Internet.aspx.cs" Inherits="Advertiser.WebForm5" %>
...
<div id="FU1">
  <br />
        <br />
        <table style="border-style: inset; border-color: inherit; border-width: thin; left: 252px; width: 587px; position: absolute; top: 168px; height: 563px;
           background-color:#99FFCC">
            <tr>
                <td colspan="2" style="height: 1px">
                    <span style="font-size: 14pt">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span
                        style="font-family: Times New Roman">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;<span style="color: #00ff33"> <span style="color: #990000">
                            AdvertiseThrough Internet</span></span></span><br />
                        <br />
                    </span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="width: 281px; height: 40px">
                    <asp:TextBox ID="Fdate" runat="server" TextMode="Date" 
                        ...
                        style="margin-bottom: 1px; z-index: 1; left: 247px; top: 127px; position: absolute;"></asp:TextBox>
                    <br />
                    <br />
                    &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td>
            ...
            <tr>
                ...
                <td style="width: 281px; height: 37px">
                    <asp:TextBox ID="Tdate" runat="server" TextMode="Date" 
                        style="z-index: 1; left: 247px; top: 161px; position: absolute"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="width: 1px; height: 37px">
                ...
                <td style="width: 281px; height: 37px">
            <asp:DropDownList ID="DD2" runat="server" style="left: 185px;" >
            ...
            <tr>
                ...
                <td style="width: 281px; height: 28px">
                    <asp:FileUpload ID="Fu1" runat="server" style="height: 22px" /></td>
            </tr>
            <tr>
                <td colspan="2">
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
