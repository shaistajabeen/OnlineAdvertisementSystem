<%@ Page Title="" Language="C#" MasterPageFile="~/Adsmedium.Master" AutoEventWireup="true" CodeBehind="Banner.aspx.cs" Inherits="Advertiser.WebForm9" %>
...
<div>
        ...
        <table style="border-style: inset; border-color: inherit; border-width: thin; left: 237px; width: 565px; position: absolute; top: 171px; height: 177px;
                ...
                <td colspan="2" style="height: 2px">
                    <span style="font-size: 14pt">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span
                        style="font-family: Times New Roman">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;<span style="color: #00ff33">
                            ...
                            Advertise In Digital Banners</span></span></span><br />
                    </span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width: 281px; height: 24px">
                    <asp:DropDownList
                ID="DD2" runat="server" style="left: 183px;" >
            ...
            <tr>
                ...
                <td style="width: 281px; height: 24px">
            <asp:DropDownList ID="DD3" runat="server" style="left: 184px;">
                <asp:ListItem>NONE</asp:ListItem>
            </asp:DropDownList></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" style="height: 28px">
                    <span style="font-size: 7pt"><span style="color: #ff0000">*</span> <span style="color: #ff0000">
                        Small</span>:&lt;10mx5 m,<span style="color: #ff0000">Large</span>:&lt;20mx15 m,<span
                            style="color: #ff0000">Ex-Large</span>:30mx25 m</span></td>
            </tr>
            <tr>
        ...
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
        <table style="left: 815px; width: 205px; position: absolute; top: 175px; margin-left: 0px;">
            <tr>
            ...
            <tr>
                ...
                <img src="Images/laysandpepsi.jpg" />
                    </td>
            ...
            <tr>
                <td colspan="3" style="height: 21px">
              <img src="Images/shrek-twinkies.jpg" />
                    </td>
            </tr>
            <tr>
                <td colspan="3" style="height: 21px; background-color: #99ccff">
